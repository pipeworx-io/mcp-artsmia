...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/artsmia_search_artworks \
  -H 'Content-Type: application/json' \
  -d '{"query":"monet water lilies"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/artsmia_search_artworks`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
